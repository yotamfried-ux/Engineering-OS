...
- superseded pre-merge: `6855c7d66c08edba02ff9ab9adbcb79c19cc4d1f` had green CI but was subsequently proven to permit repeat authorization from the same approval; that evidence is historical only.
...
- pre-merge: exact implementation target `7795c967c1be5ecadd7e31c68da3159067316368` passed 111/111 local test suites plus provider validation, clean install, installed-target, static shell/Python/YAML checks and one-shot/fail-closed regressions; `554ae5b14ec08ddf455325647ab37a3c29eb9333` removed the temporary export workflow; the audit-scope correction removed 11 unrelated bootstrap/qualification commits and changed only plan/runbook/template documentation. This records the verified implementation checkpoint after the final code/config/test change.
