...
- decision: selected the existing hard-hook tree and kept the four canonical PR #261 closure blobs from `main`, instead of rebasing by text copy or reopening the closed documentation gap.
