...
- pre-merge: this final checkpoint was committed after the latest branch cleanup and documentation changes.
...
- [x] Final checkpoint committed after latest branch changes.
