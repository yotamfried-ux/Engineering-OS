# Agent Eval Corpus Expansion Plan
...
| Domain tags | governance, evals, workflow, connectors, mcp, reviews, security, testing |
...
| Recent PR history #89 and #90 | Provides real failure modes for CodeRabbit, review threads, managed settings, and MCP verification | Reviewed through GitHub PR state |

## Connector Evidence

| Connector | Evidence |
|---|---|
| GitHub | Used to read existing corpus/test files, create this implementation branch, and update PR files. |
