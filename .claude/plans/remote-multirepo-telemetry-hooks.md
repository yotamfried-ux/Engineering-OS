...
| Official Claude Code settings/hooks documentation | consulted | User-level settings load across sessions; project settings depend on project/session scope; hooks from applicable scopes merge. |
