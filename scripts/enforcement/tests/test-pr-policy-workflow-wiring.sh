...
req('policy_args+=(--policy-file "$trusted_policy")' in text and '"${policy_args[@]}"' in text,'selector must pass the trusted base policy explicitly only when it exists and is valid')
