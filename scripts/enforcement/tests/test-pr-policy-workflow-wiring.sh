...
req('--policy-file .engineering-os/trusted-policy-source/.engineering-os/telemetry-policy.json' in text,'selector must receive the trusted base policy explicitly')
