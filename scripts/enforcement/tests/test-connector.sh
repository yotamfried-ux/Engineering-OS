...
ghpat="github_pat_"; ghpat="${ghpat}0123456789abcdefghij_KLMNOP"
skproj="sk-proj-"; skproj="${skproj}abcdefghijklmnopqrstuvwxyzABCDEFGHIJ0123456789"
...
expect "GitHub classic token blocked" 1 "$(stage_run tok.js "token = \"$ghp\"")"
expect "GitHub fine-grained PAT blocked" 1 "$(stage_run pat.js "token = \"$ghpat\"")"
