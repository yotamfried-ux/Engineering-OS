...
stage_code 1
failcase bug_fix_requires_lesson_failed_solution_or_waiver run_gate

setup_repo
write_plan debugging "payments, webhooks"
stage_code 2
stage_valid_lesson
pass bug_fix_allows_staged_lesson run_gate

setup_repo
write_plan incident "payments, webhooks"
stage_code 3
stage_failed_solution
pass incident_allows_failed_solution_record run_gate

setup_repo
write_plan bug_fix "payments, webhooks" "This was a trivial typo with no reusable root cause and no failed attempt."
stage_code 4
pass waiver_allows_no_lesson_case run_gate
