...
| **graphify** | ✅ **כן, בכל פרויקט** | חוסך עלות קונטקסט בכל סשן. בריפו שעדיין זעיר דוחים את *בניית הגרף* בלבד — הסקיל נשאר בפרופיל ברירת המחדל ומוערך מחדש בכל הרצת bootstrap ככל שהריפו גדל. **אין הדרה קבועה** — פרוטוטייפ שגדל מקבל גרף אוטומטית בסשן הבא. |
...
| [graphify](../external-skills/graphify/) | context-optimization | L1 | ✅ כל פרויקט (גרף מוערך מחדש לפי גודל) | `uv tool install` + MCP |
