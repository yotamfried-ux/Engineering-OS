...
| **graphify** | ✅ **כן, לכל ריפו לא-זעיר** | חוסך עלות קונטקסט בכל סשן (שאיפת הבעלים: בכל פרויקט). מדלגים רק על ריפו זעיר שבו הגרף לא משתלם. |
...
| [graphify](../external-skills/graphify/) | context-optimization | L1 | ✅ ריפו לא-זעיר | `uv tool install` + MCP |
