...
- **תוכן ה-plan הפעיל**: אם קיים `.claude/plans/*.md`, כלול את שמות הקבצים ואת
  סעיפי Goal ו-DoD במלואם — קבצי plan אינם שמורים ב-git ונמחקים כשה-container
  מוחלף אחרי compaction. הכללתם בסיכום מאפשרת שחזורם בסשן הבא.
